...
import kalman.CholeskyDecompositionCommon_D64;
...
import kalman.AdjustableLinearSolver;
import kalman.LinearSolverChol;
import kalman.LinearSolverCholBlock64;
import kalman.LinearSolverLu;
import kalman.misc.qr.*;
import kalman.SolvePseudoInverseSvd;
...
public class LinearSolverFactory {
     ...
     * then the basic solution is returned.  See {@link kalman.alg.dense.linsol.qr.BaseLinearSolverQrp}
