...
import kalman.EjmlParameters;
import kalman.UtilEjml;
import kalman.LUDecompositionAlt_D64;
import kalman.LinearSolverSafe;
import kalman.LinearSolverLu;
import kalman.misc.*;
import kalman.MatrixMatrixMult;
import kalman.MatrixMultProduct;
import kalman.MatrixVectorMult;
import kalman.D1Matrix64F;
import kalman.DenseMatrix64F;
import kalman.ReshapeMatrix64F;
import kalman.RowD1Matrix64F;
import kalman.LinearSolverFactory;
import kalman.LinearSolver;
import kalman.ReducedRowEchelonForm;
 ...
 * </p>
 * <p>
 * For more exotic and specialized generic operations see {@link kalman.ops.SpecializedOps}.
 * </p>
 * @see kalman.alg.dense.mult.MatrixMatrixMult
 * @see kalman.alg.dense.mult.MatrixVectorMult
 * @see kalman.ops.SpecializedOps
 * @see kalman.ops.MatrixFeatures
 *
 * @author Peter Abeles
 */
...
public class CommonOps {
     ...
     * vectors there is an even faster option, see {@link kalman.alg.dense.mult.VectorVectorMult#innerProd(kalman.data.D1Matrix64F, kalman.data.D1Matrix64F)}
     * </p>
     *
     ...
     * {@link #transpose(kalman.data.DenseMatrix64F, kalman.data.DenseMatrix64F)} is invoked.
     * </p>
     *
     ...
     * needed, then using {@link kalman.alg.dense.decomposition.lu.LUDecompositionAlt_D64} directly (or any
     ...
     * </p>
     * <p>
     * Internally it uses {@link kalman.alg.dense.linsol.svd.SolvePseudoInverseSvd} to compute the inverse.  For performance reasons, this should only
