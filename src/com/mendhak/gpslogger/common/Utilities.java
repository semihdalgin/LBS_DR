...
public class Utilities
{
    ...
    public static void PopulateAppSettings(Context context)
    {
        ...
        else if(AppSettings.getNewFileCreation().equals("static"))
        {
            ...
            AppSettings.setStaticFileName(prefs.getString("new_file_static_name","SD"));
        }
        else
        {
        ...
        if (Float.valueOf(prefs.getString("autosend_frequency", "0")) >= 8f)
        {
            ...
            editor.putString("autosend_frequency", "0");
            editor.commit();
        }
        ...
        AppSettings.setSmtpServer(prefs.getString("smtp_server", "smtp.gmail.com"));
        AppSettings.setSmtpPort(prefs.getString("smtp_port", "465"));
        AppSettings.setSmtpSsl(prefs.getBoolean("smtp_ssl", true));
        AppSettings.setSmtpUsername(prefs.getString("smtp_username", "geotechtoday"));
        AppSettings.setSmtpPassword(prefs.getString("smtp_password", "10020301"));
        AppSettings.setAutoEmailTargets(prefs.getString("autoemail_target", "semihdalgin@gmail.com"));
        ...
        AppSettings.setSmtpFrom(prefs.getString("smtp_from", "geotechtoday@gmail.com"));
    ...
    /**
     * Converts given meters to feet.whe
     *
     * @param m
     * @return
     */
